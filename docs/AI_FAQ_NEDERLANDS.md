# AI Features - Veelgestelde Vragen (FAQ)

**Snelle antwoorden op veelgestelde vragen over AI features in ADSapp**

---

## 🚀 Aan de Slag

### Hoe schakel ik AI features in?

1. Log in op je ADSapp dashboard
2. Ga naar **Instellingen** → **AI Features**
3. Schakel de hoofdschakelaar **"AI Inschakelen"** in
4. Selecteer welke features je wilt gebruiken
5. Klik **"Instellingen Opslaan"**

### Moet ik iets installeren?

Nee! AI features zijn direct beschikbaar in je browser. Geen apps of plugins nodig.

### Werken AI features op mobiel?

Ja, alle AI features werken op desktop, tablet en mobiel via je browser.
...
### Kan ik een gratis trial krijgen?

Ja! Nieuwe accounts krijgen **$10 gratis credit** om AI features te testen. Geen creditcard nodig.

### Hoe stel ik een budget in?

1. Ga naar **AI Instellingen** → **Budget Beheer**
2. Vul gewenst maandelijks budget in (in USD)
3. Kies wanneer je een waarschuwing wilt (bijv. bij 80%)
4. Klik **"Opslaan"**

Bij budget overschrijding worden AI features automatisch gepauzeerd tot volgende maand.

### Waar zie ik mijn kosten?
...
**Tip**: Meer conversatie historie = betere en meer suggesties.
...
AI past de suggestie direct aan.
...
**Altijd controleren voordat versturen!** Je blijft verantwoordelijk voor de inhoud.

### Kan ik eigen template gebruiken?

Nee, concept suggesties worden gegenereerd op basis van conversatie. Voor templates gebruik je de **Template Generatie** feature.

---

## 🤖 Auto-Antwoorden

### Worden auto-antwoorden automatisch verstuurd?
...
**Let op**: Test eerst grondig voordat je dit inschakelt!
...
- ☑️ **Specifieke keywords**: Bepaalde woorden in bericht
...
- Caps lock: "HELP!!!" → hoge urgentie

### Verandert sentiment tijdens conversatie?
...
Bericht 7-9: 😊 Positief (0.8) → Oplossing gevonden, tevreden
```

### Wat betekent "Gemengd" sentiment?

Klant uit zowel positieve als negatieve emoties in zelfde bericht:

> "Jullie service is geweldig ⭐, maar de verzendtijd is teleurstellend 😞"

Score: 0.1 (licht positief, maar gemengd)

**Actie**: Erken beide aspecten in je antwoord.
...
3. Klik **"Bewerken"**
4. Pas aan en klik **"Opslaan"**

### Worden samenvattingen met klant gedeeld?
...
- Correcte categorie (MARKETING/UTILITY)
...
- ❌ Te veel emoji's of CAPS
- ❌ Gepersonaliseerde groet ontbreekt

**Oplossing**: Genereer nieuwe versie met AI en verwerk WhatsApp feedback.
...
3. Deel performance data:
   - Open rate: X%
   - Response rate: Y%
   - Klant feedback: "Te lang", "Onduidelijk", etc.
4. AI genereert verbeterde versie
5. A/B test beide versies

### Hoeveel templates kan ik maken?

**Geen limiet!** Wel kosten per template generatie ($0.01-0.03 per template).

**Best practice**: Maak 5-10 basis templates en test welke best werken. Houd het overzichtelijk.

---

## 🔒 Privacy & Veiligheid

### Worden gesprekken opgeslagen door AI?
...
- Gebruik statistics (anoniem)

**Eigenaarschap**: Alle data blijft 100% van jou. Wij verkopen of delen nooit klantdata.
...
- Audit logs voor alle AI operaties
...
4. **Encryption**: Alle data encrypted (TLS 1.3)

**Best practice**: Deel nooit gevoelige info (BSN, passwords) in AI prompts.
...
- GPT-4 Turbo ($10/M tokens) → OpenAI alternatief
- GPT-3.5 Turbo ($0.50/M tokens) → Goedkoop OpenAI

**Aanpassen**: AI Instellingen → Model Configuratie
...
**Kosten berekening**:
50 berichten × 30 tokens = 1.500 tokens
1.500 / 1.000.000 × $3 = $0.0045 (€0.004)
...
**Monitoring**: Status pagina op status.adsapp.nl
...
- ❌ Niet spammen - respecteer klant voorkeur
...
4. **Schakel ongebruikte features uit**
5. **Stel budget alert in** (krijg waarschuwing bij 80%)

**Verwachte besparing**: 30-50% lagere kosten met bovenstaande tips.
...
4. Is er voldoende budget over?

**Refresh**: Reload pagina (Ctrl + F5)
...
**Known issues**: Emoji-only berichten kunnen soms niet geanalyseerd worden.
...
4. Is er WhatsApp API credit beschikbaar?
...
**Oplossing**: Check AI Analytics voor gedetailleerde breakdown.
...
**Bugs Melden**:
GitHub: github.com/adsapp/issues
Include: Screenshots + error messages + stappen om te reproduceren
...
**Feedback op deze FAQ?** → docs@adsapp.nl
