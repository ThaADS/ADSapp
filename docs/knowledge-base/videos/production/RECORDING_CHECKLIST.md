# ADSapp Video Production - Recording Day Checklist

Comprehensive checklist for efficient, error-free video recording sessions.
...
- [ ] Demo account fully configured with test data
- [ ] Screen recordings mapped to script timestamps
- [ ] Graphics/assets prepared and organized
- [ ] Background music selected and downloaded
...
- [ ] Templates created (5-10)
- [ ] Automation rules configured (3-5)
- [ ] Team members invited for multi-user demos
...
- [ ] ADSapp tested in recording browser
...
- [ ] "Recording in Progress" sign prepared
...
- [ ] Well-rested (critical for performance)
- [ ] Meals planned (avoid dairy before recording - phlegm)
...
- [ ] Pets secured in different room
- [ ] Family/roommates notified of recording schedule
...
4. [ ] Connect and test headphones
5. [ ] Position and focus camera
6. [ ] Open recording software
...
- [ ] Codec: H.264
- [ ] Bitrate: 10-15 Mbps
- [ ] Audio input: Correct microphone selected
- [ ] Audio levels: -18dB average, peak -3dB
- [ ] Save location: Correct drive with space
- [ ] File naming convention configured
...
- [ ] Review lighting (no harsh shadows)
- [ ] Check background appearance
- [ ] Verify screen capture area correct
- [ ] Test mouse cursor visibility and size
...
- [ ] Clear throat with water
- [ ] Deep breathing exercises (1 minute)
- [ ] Verify recording settings haven't changed
...
- [ ] Clap or snap for audio sync if separate tracks
- [ ] Wait 2 seconds
- [ ] Begin narration
...
- [ ] Follow mouse movement guidelines:
  ...
  - Hold clicks for 0.5 seconds
  - Pause at each UI element
  - Avoid erratic jumping
- [ ] Monitor audio levels (glance, don't obsess)
- [ ] If mistake: pause, say "pickup from [point]", continue
...
- [ ] Make notes: "Take 2 - best", "Take 3 - stumbled at 2:15"
- [ ] Decide: Good? Retake? Move on with note to fix?
...
- [ ] Drink water
- [ ] Rest voice (no talking)
- [ ] Stretch body
- [ ] Check time vs progress
- [ ] Review notes from previous videos
...
- Eat/drink during recording (water between takes only)
- Record when tired or sick
...
- Use zoom/highlight features for small elements
- Record extra B-roll footage
...
- Navigate too fast for viewers to follow
- Forget to show results of actions
...
- [ ] Turn off camera
- [ ] Turn off microphone/interface
- [ ] Turn off lights
- [ ] Coil cables neatly
- [ ] Cover equipment with dust covers
- [ ] Return room to normal state
...
- [ ] No factual errors
- [ ] Demo account data appropriate
- [ ] Timing matches estimates
- [ ] All storyboard shots captured
- [ ] B-roll footage adequate

---

## Common Recording Problems & Solutions
...
- **10:00 AM**: Video 2 recording (1.5 hours)
- **11:30 AM**: Break (30 min)
- **12:00 PM**: Video 3 recording (1.5 hours)
- **1:30 PM**: Review and backup (30 min)
...
- **10:45 AM**: Video 5 recording (1.5 hours)
- **12:15 PM**: Review and backup (30 min)
...
**Total Recording Time Estimate**: 10-12 full days

---

## Recording Efficiency Tips

1. **Batch Similar Videos**: Record all "setup" videos in one session while environment is configured

2. **Record Multiple Takes**: 2-3 takes of each section provides editing options

3. **Overshoot B-Roll**: Extra footage of UI, animations, workflows useful in editing

4. **Use Teleprompter App**: Display script near camera for more natural delivery

5. **Record Room Tone**: 60 seconds of silence in recording space for noise reduction

6. **Test First, Record Second**: Always do test recording before "real" takes

7. **Stand When Recording Voiceover**: Better breath support and energy

8. **Time of Day Matters**: Your voice sounds different - stay consistent

9. **Hydrate Properly**: Room-temperature water, avoid ice (constricts vocal cords)

10. **Save Often**: Auto-save in software, manual save after each take

---

**Recording preparation complete! Next: Review EDITING_GUIDELINES.md for post-production process.**
