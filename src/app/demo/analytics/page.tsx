  ...
  return (
    <div className='rounded-lg border border-gray-200 bg-white p-6'>
      <div className='mb-4 flex items-center justify-between'>
        <div className='flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-green-100 to-blue-100'>
          {icon}
        </div>
        {change && (
          <span
...
function ChartPlaceholder({
  ...
  return (
    <div className='rounded-lg border border-gray-200 bg-white p-6'>
      ...
      <div className='flex h-64 items-center justify-center rounded-lg bg-gradient-to-br from-green-50 to-blue-50'>
...
function ResponseTimeChart() {
  ...
  return (
    <div className='rounded-lg border border-gray-200 bg-white p-6'>
      ...
      <div className='relative flex h-64 items-center justify-center overflow-hidden rounded-lg bg-gradient-to-br from-green-50 to-blue-50'>
      ...
      <div className='mt-4 flex items-center justify-between text-sm'>
        ...
        <div className='font-medium text-green-600'>-23% vs last period</div>
      </div>
    </div>
  )
}
...
function ConversationsByScenario() {
  ...
  return (
    <div className='rounded-lg border border-gray-200 bg-white p-6'>
      <h3 className='mb-4 text-lg font-semibold text-gray-900'>Conversation Categories</h3>
      ...
      <div className='mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8'>
        <div className='grid grid-cols-1 gap-8 lg:grid-cols-4'>
          ...
          <div className='space-y-6'>
            ...
            {/* Demo analytics */}
            <div className='rounded-lg border border-gray-200 bg-white p-6'>
              <h3 className='mb-4 text-lg font-semibold text-gray-900'>Demo Statistics</h3>
              <div className='space-y-4'>
