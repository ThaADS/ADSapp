            ...
            <ul role='list' className='flex flex-1 flex-col gap-y-7'>
              ...
              <li className='mt-auto'>
                <button
                  ...
                  className='group -mx-2 flex w-full gap-x-3 rounded-xl p-3 text-sm leading-6 font-semibold text-slate-700 transition-all hover:bg-slate-50 hover:text-red-600'
                >
                  <ArrowRightOnRectangleIcon
                    className='h-6 w-6 shrink-0 text-slate-400 transition-colors group-hover:text-red-600'
                    aria-hidden='true'
                  />
                  Sign out
                </button>
          ...
          <div className='flex flex-1 gap-x-4 self-stretch lg:gap-x-6'>
            ...
            <div className='flex items-center gap-x-4 lg:gap-x-6'>
              ...
              <div className='flex items-center gap-x-3 lg:hidden'>
                <button
                  onClick={handleSignOut}
                  className='flex items-center gap-x-2 rounded-lg px-3 py-2 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-100'
                >
