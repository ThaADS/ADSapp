      ...
      <div className='flex items-center gap-4'>
        ...
        <div className='flex-1'>
          ...
          <div className='mt-1 flex items-baseline gap-2'>
            ...
            {trend !== undefined && (
              <span
                className={`text-xs font-semibold ${trend >= 0 ? 'text-emerald-600' : 'text-red-600'}`}
              >
                {trend >= 0 ? '+' : ''}
                {trend}%
              </span>
...
export function BillingOversight() {
  ...
  const getStatusBadge = (status: string, cancelAtPeriodEnd: boolean) => {
    if (cancelAtPeriodEnd) {
      return (
        <span className='inline-flex items-center gap-x-1.5 rounded-full bg-orange-50 px-3 py-1 text-xs font-medium text-orange-700 ring-1 ring-orange-600/20 ring-inset'>
    ...
    return (
      <span
        className={`inline-flex items-center gap-x-1.5 rounded-full px-3 py-1 text-xs font-medium ring-1 ring-inset ${badge.class}`}
      >
    ...
    <div className='space-y-6'>
      ...
      {metrics && (
        <div className='grid grid-cols-1 gap-4 sm:grid-cols-4'>
          <div className='rounded-xl bg-gradient-to-br from-emerald-50 to-emerald-100 p-4 ring-1 ring-emerald-600/20'>
          ...
          <div className='rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 p-4 ring-1 ring-blue-600/20'>
            <div className='flex items-center gap-3'>
          ...
          <div className='rounded-xl bg-gradient-to-br from-red-50 to-red-100 p-4 ring-1 ring-red-600/20'>
            <div className='flex items-center gap-3'>
          ...
          <div className='rounded-xl bg-gradient-to-br from-slate-50 to-slate-100 p-4 ring-1 ring-slate-600/20'>
            <div className='flex items-center gap-3'>
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='mt-1 text-sm text-slate-600'>
                Detailed view of all organization subscriptions
              </p>
            </div>
            <select
              value={filterStatus}
