            ...
            <div>
              ...
              <div className="mt-1 flex items-center space-x-4">
                ...
                <div className="flex space-x-2">
                  <label className="px-4 py-2 bg-white text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 text-sm font-medium cursor-pointer">
                  ...
                  {logoUrl && (
                    <button
                      ...
                      disabled={uploadingLogo}
                      className="px-4 py-2 bg-white text-red-600 border border-red-300 rounded-lg hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 text-sm font-medium disabled:opacity-50"
                    >
                      Remove
                    </button>
                  )}
