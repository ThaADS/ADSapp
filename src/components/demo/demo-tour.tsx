...
const TOUR_STEPS: Record<string, TourStep[]> = {
  welcome: [
    {
      ...
      content: 'Let\'s take a quick tour of your new WhatsApp Business inbox. This demo will show you how to manage conversations like a pro.',
      target: 'body',
      position: 'center',
    },
    {
      ...
      content: 'Here you\'ll see all your WhatsApp conversations. Each conversation shows the customer name, last message, and status.',
    ...
    },
    {
      id: 'welcome-3',
      title: 'Chat Window',
      content: 'This is where you\'ll read and respond to messages. The interface is designed for fast, efficient communication.',
    ...
    },
    {
      id: 'welcome-4',
      title: 'Message Input',
      content: 'Type your responses here. You can send text, emojis, images, and use templates for quick replies.',
  ...
  'inbox-overview': [
    {
      ...
      content: 'Your inbox is organized to help you work efficiently. Let\'s explore the key features.',
      target: 'body',
      position: 'center',
    },
    {
      ...
      content: 'Conversations are color-coded: Green for active, Yellow for pending, and Gray for resolved.',
    ...
    },
    {
      id: 'inbox-3',
      title: 'Quick Actions',
      content: 'Right-click any conversation for quick actions like assign, tag, or mark as resolved.',
    ...
    },
    {
      id: 'inbox-4',
      title: 'Search & Filter',
      content: 'Use the search bar to quickly find conversations by customer name, phone number, or message content.',
  ...
  'handle-inquiry': [
    {
      ...
      content: 'Let\'s respond to Sarah\'s order inquiry. This is a common scenario you\'ll handle daily.',
      target: 'body',
      position: 'center',
    },
    {
    ...
    },
    {
      ...
      content: 'Sarah is asking about her order status. Notice the urgency tag - this helps prioritize responses.',
    ...
    },
    {
      ...
      content: 'Type a helpful response. Be professional, friendly, and provide specific information.',
      target: '[data-tour="message-input"]',
      position: 'top',
      action: 'type',
  ...
  'use-templates': [
    ...
    },
    {
      ...
      content: 'Select a template that matches the customer\'s inquiry. You can customize it before sending.',
    ...
    },
    {
      ...
      content: 'Edit the template to add personal touches, then send. Templates make responses faster and more consistent.',
      target: '[data-tour="message-input"]',
      position: 'top',
    },
  ],
...
function TourTooltip({
  ...
  return (
    <div className="bg-white rounded-lg shadow-xl border border-gray-200 p-6 max-w-sm relative z-50">
      {/* Header */}
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
          <div className="flex items-center space-x-2">
            <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center">
              ...
              {step.action === 'hover' && (
                <svg className="w-3 h-3 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2m-9 3v11a2 2 0 002 2h6a2 2 0 002-2V7M7 7h10M9 7v4m6-4v4" />
                </svg>
              )}
            </div>
            <span className="text-sm text-blue-800 font-medium">{step.actionText}</span>
          </div>
        </div>
      )}
  ...
  return (
    <>
      ...
      {currentStep.position === 'center' && (
        <div className="fixed inset-0 bg-black/50 z-30" onClick={handleSkip} />
      )}
    </>
  );
}
...
export function TourTrigger() {
  ...
  return (
    <button
      onClick={showTour}
      className="fixed bottom-6 right-6 z-30 bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-full shadow-lg transition-colors"
