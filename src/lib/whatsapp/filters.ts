...
export class ConversationFilterManager {
  ...
  private initializeDefaultFilters() {
    this.quickFilters = [
      ...
      // Category Tags (Predefined User Tags)
      {
        id: 'sales',
        name: 'Sales',
      ...
      },
      {
        id: 'leads',
        name: 'Leads',
        description: 'Lead generation conversations',
        icon: 'target',
        criteria: { tags: ['leads'] },
        sortBy: { field: 'last_message_at', direction: 'desc' },
        isSystem: false,
      },
      {
        id: 'follow-up',
        name: 'Follow-up',
        description: 'Conversations requiring follow-up',
        icon: 'calendar',
        criteria: { tags: ['follow-up'] },
        sortBy: { field: 'last_message_at', direction: 'desc' },
        isSystem: false,
      },
      {
      ...
      },
      {
        id: 'backoffice',
        name: 'Backoffice',
        description: 'Back office related conversations',
        icon: 'briefcase',
        criteria: { tags: ['backoffice'] },
        sortBy: { field: 'last_message_at', direction: 'desc' },
        isSystem: false,
      },
      {
        id: 'administratie',
        name: 'Administratie',
        description: 'Administrative conversations',
        icon: 'file-text',
        criteria: { tags: ['administratie'] },
        sortBy: { field: 'last_message_at', direction: 'desc' },
        isSystem: false,
      },
      // Team Member Tags
      {
        id: 'agent-1',
        name: 'Agent 1',
        description: 'Conversations for Agent 1',
        icon: 'user',
        criteria: { tags: ['agent-1'] },
        sortBy: { field: 'last_message_at', direction: 'desc' },
        isSystem: false,
      },
      {
        id: 'agent-2',
        name: 'Agent 2',
        description: 'Conversations for Agent 2',
        icon: 'user',
        criteria: { tags: ['agent-2'] },
        sortBy: { field: 'last_message_at', direction: 'desc' },
        isSystem: false,
      },
      {
        id: 'agent-3',
        name: 'Agent 3',
        description: 'Conversations for Agent 3',
        icon: 'user',
        criteria: { tags: ['agent-3'] },
        sortBy: { field: 'last_message_at', direction: 'desc' },
        isSystem: false,
      },
    ]
