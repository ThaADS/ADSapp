...
const DYNAMIC_CACHE_URLS = ['/api/', '/dashboard/', '/_next/static/', '/_next/image']
...
self.addEventListener('push', event => {
  ...
  event.waitUntil(self.registration.showNotification('ADSapp', options))
})
...
self.addEventListener('notificationclick', event => {
  ...
  if (event.action === 'reply') {
    ...
    event.waitUntil(clients.openWindow(event.notification.data.url || '/dashboard/inbox'))
  }
})
