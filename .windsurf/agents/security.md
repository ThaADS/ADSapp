...
describe('Security Tests', () => {
  test('prevents SQL injection', async () => {
    ...
    const response = await request(app).post('/api/users/search').send({ query: maliciousInput })
  ...
  test('blocks XSS attempts', async () => {
    ...
    const response = await request(app).post('/api/posts').send({ content: xssPayload })
