    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 p-6 rounded-lg">
        ...
        <p className="mt-3 text-sm text-gray-600">
          ⏱️ 2 minutes • Step-by-step guide
        </p>
      </div>
      ...
      <div>
        ...
        {/* Visual helper */}
        <div className="mb-3 p-4 bg-gray-50 rounded border">
          <p className="text-sm font-medium mb-2">Where to find this:</p>
          <Image
        ...
        {validationStatus === 'validating' && (
          <p className="text-blue-600 text-sm mt-2">🔄 Validating...</p>
        )}
        {validationStatus === 'valid' && (
          <p className="text-green-600 text-sm mt-2">✅ Valid Phone Number ID</p>
        )}
        {validationStatus === 'invalid' && (
          <p className="text-red-600 text-sm mt-2">❌ Invalid ID. Please check and try again.</p>
        )}
      </div>
